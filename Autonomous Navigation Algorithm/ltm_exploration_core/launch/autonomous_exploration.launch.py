...
def generate_launch_description():
    ...
    # Ground plane segmentation node
    ...
    # Navigation service node
    navigation_service_config_filepath = os.path.join(
        get_package_share_directory('ltm_navigation_service'), 'config', 'parameters.yaml')
    ...
    navigation_client_node = Node(
        package='ltm_navigation_service',
        executable='navigation_client_node',
        name='navigation_client_node',
        output='screen',
    )
    
    # Frontier exploration node
    exploration_params_filepath = os.path.join(
        get_package_share_directory('ltm_exploration_core'), 'config', 'exploration_params.yaml')
    frontier_exploration_node = Node(
        package='ltm_exploration_core',
        executable='frontier_exploration_node',
        name='frontier_exploration_node',
        output='screen',
        parameters=[exploration_params_filepath]
    )
    
    return LaunchDescription([
        # Sensor processing and SLAM
